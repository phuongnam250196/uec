...
class StudentController extends Controller
{
    ...
    public function getStudentInfo() {
        ...
        $data = StudentModel::join('uec_user', 'uec_student.id', '=', 'uec_user.student_id')
                // ->join('uec_area', 'uec_student.area_id', '=', 'uec_area.id')
                ->join('uec_specialize', 'uec_student.specialize_id', '=', 'uec_specialize.id')
                ->where('student_id', Auth::user()->student_id)
                // ->select('uec_student.id')
                ->first();
                // dd(Auth::user()->student_id, Auth::id(),$data);
        return view('frontend.sinhvien.pr_sinhvien_info')->with(compact('enterprise', 'data'));
    }
    ...
    public function getStudentUpdateInfo() {
        ...
        return view('frontend.sinhvien.pr_sinhvien_info_edit', compact('enterprise', 'studentInfo', 'area', 'science', 'specialize', 'course'));
    }
    public function postStudentUpdateInfo(FUpdateUserInfoRequest $request) {
        $studentInfo = StudentModel::join('uec_user', 'uec_user.student_id', '=', 'uec_student.id')
        ...
        $data->student_head_teacher = $request->student_head_teacher;
        $data->save();
    ...
    public function getStudentUpdateWork() {
        ...
        ->where('uec_user.id', Auth::id())->first();
        return view('frontend.sinhvien.pr_sinhvien_update_work', compact('enterprise', 'studentWork'));
    }
    ...
    public function getHosoAdd() {
        ...
        return view('frontend.sinhvien.pr_sinhvien_hoso_add', compact('enterprise', 'area', 'formality', 'yearofexp', 'career', 'education'));
    }
    ...
    public function getHosoEdit($id) {
        ...
        // dd($cv);
        return view('frontend.sinhvien.pr_sinhvien_hoso_edit', compact('enterprise', 'area', 'formality', 'yearofexp', 'career', 'education', 'cv'));
    }
    ...
    public function getKetqua() {
        ...
        $st = StudentModel::join('uec_user', 'uec_user.student_id', '=', 'uec_student.id')->where('uec_user.id', Auth::id())->first();
        // $kqs = Jobapp_RecruitmentModel::join('uec_recruitment', 'uec_recruitment.id', '=', 'uec_jobapp_recruitment.recruitment_id')
        //         // ->join('uec_recruitment', 'uec_recruitment.enterprise_id', '=', 'uec_enterprises.id')
        //         ->where('student_id', $st->student_id)
        //         ->get();

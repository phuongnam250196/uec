...
class EnterpriseController extends Controller
{
    ...
    public function getDNInfo($id) {
        ...
        $data = EnterprisesModel::join('uec_user', 'uec_enterprises.id', '=', 'uec_user.enterprise_id')
                ->join('uec_area', 'uec_enterprises.area_id', '=', 'uec_area.id')
                ->where('uec_user.id', $id)
                ->first();
        // dd($data, $enterprise);
        return view('frontend.doanhnghiep.pr_doanhnghiep_info', compact('enterprise', 'data'));
    }
    public function getResetpassword($id) {
        
        return view('frontend.doanhnghiep.pr_doanhnghiep_reset_password');
    }

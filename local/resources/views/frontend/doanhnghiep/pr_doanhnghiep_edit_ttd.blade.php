                        ...
                        <div class="row pr_dn_add_ttd_row">
                            ...
                            <div class="col-lg-3 col-sm-4 pr_dn_add_col">
                                <div class="form-group" >
                                    ...
                                    <img id="avatar" class="thumbnail" src="{{url('local/storage/app/tintuyendung/'.$recruit->recruitment_img)}}" width="100%">
                            ...
                            <div class="col-lg-12 pr_dn_add_col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="recruitment_describe" rows="4" cols="0.5">{{$recruit->recruitment_describe}}</textarea>
                            ...
                            <div class="col-lg-12 pr_dn_add_col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="recruitment_benefit" rows="4">{{$recruit->recruitment_benefit}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 pr_dn_add_col">
                                <div class="form-group">
                                    <label>Yêu cầu khác</label>
                                    <textarea class="form-control" name="recruitment_requirements" rows="4">{{$recruit->recruitment_requirements}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12 pr_dn_add_col">
                                <div class="form-group">

                    ...
                    <form class="pr_dn_ttd_form" method="post" enctype="multipart/form-data">
                        <div class="row pr_dn_add_ttd_row">
                             <div class="col-lg-4 pr_dn_add_col">
                                {{-- <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" name="training_img">
                            ...
                            <div class="col-lg-8 pr_dn_add_col">
                                ...
                                <div class="form-group">
                                    <label>Hạn nộp</label>
                                    <input type="date" class="form-control" name="training_deadline" value="{{old('training_deadline')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="training_address" value="{{old('training_address')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="skill_id" class="custom-select">
                                      ...
                                      @foreach($skill as $ski)
                                        <option value="{{$ski->id}}">{{$ski->skill_name}}</option>
                                      @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="4" cols="0.5" name="training_describe">{{old('training_describe')}}</textarea>
                                </div>
                                <div class="">
                                    <button type="submit" class="btn btn-outline-primary">Tạo khóa học</button>

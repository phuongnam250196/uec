...
<section id="breadcrumb-link">
    <div class="container">
        <ul class="breadcrumb">
          ...
          <li class="breadcrumb-item active">{{$careerOr->careerorientation_name}}</li>
        </ul>
    </div>
</section>
                ...
                <div class="thongtinsinhvien">
                    <div class="thongtinsinhvien-main">
                        <div class="thongtinsinhvien-title">
                            <h1 class="thongtinsinhvien-title-exp">{{$careerOr->careerorientation_name}}</h1>
                        </div>
                        <div class="row thongtinsinhvien-row">
                            <div class="col-md-8 thongtinsinhvien-content">
                                {!! $careerOr->careerorientation_content !!}

                            ...
                            <div class="change_password">
                                ...
                                <form  method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="4" cols="0.5" name="jobapplication_purpose">{{old('jobapplication_purpose')}}</textarea>
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="col-md-4 std_col">
                        <div class="" style="background: white">
                          @if(!empty($userImg->student_img))
                            <img style="width: 100%" src="{{asset('local/storage/app/sinhvien/'.$userImg->student_img)}}" alt="">

            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview @if(Request::is('admin/doanhnghiep/*')) active @else  @endif">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{asset('admin/doanhnghiep/thongtin')}}" @if(Request::is('admin/doanhnghiep/thongtin/*') || Request::is('admin/doanhnghiep/thongtin')) style="color:white" @endif><i class="fa fa-circle-o text-blue"></i> Danh sách doanh nghiệp</a></li>
                            <li><a href="{{asset('admin/doanhnghiep/taikhoan')}}" @if(Request::is('admin/doanhnghiep/taikhoan/*') || Request::is('admin/doanhnghiep/taikhoan')) style="color:white" @endif><i class="fa fa-circle-o text-green"></i> Tạo tài khoản doanh nghiệp</a></li>
                        </ul>
                    </li>
                    <li class="treeview @if(Request::is('admin/nhatruong/*')) active @else  @endif">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{asset('admin/nhatruong/thongtin')}}" @if(Request::is('admin/nhatruong/thongtin/*') || Request::is('admin/nhatruong/thongtin')) style="color:white" @endif><i class="fa fa-circle-o text-green"></i> Thêm thông tin trường</a></li>
                            <li><a href="{{asset('admin/nhatruong/taikhoan')}}" @if(Request::is('admin/nhatruong/taikhoan/*') || Request::is('admin/nhatruong/taikhoan')) style="color:white" @endif><i class="fa fa-circle-o text-blue"></i> Tạo tài khoản trường</a></li>
                        </ul>
                    </li>
                    <li class="treeview @if(Request::is('admin/giaovien/*')) active @else  @endif">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{asset('admin/giaovien/thongtin/list')}}" @if(Request::is('admin/giaovien/thongtin/*') || Request::is('admin/giaovien/thongtin')) style="color:white" @endif><i class="fa fa-circle-o text-blue"></i> Danh sách giáo viên</a></li>
                            <li><a href="{{asset('admin/giaovien/taikhoan')}}" @if(Request::is('admin/giaovien/taikhoan/*') || Request::is('admin/giaovien/taikhoan')) style="color:white" @endif><i class="fa fa-circle-o text-red"></i> Tạo tài khoản giáo viên</a></li>
                        </ul>
                    </li>
                    <li class="treeview @if(Request::is('admin/sinhvien/*')) active @else  @endif">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{asset('admin/sinhvien/taikhoan')}}" @if(Request::is('admin/sinhvien/taikhoan/*') || Request::is('admin/sinhvien/taikhoan')) style="color:white" @endif><i class="fa fa-circle-o"></i> Tạo tài khoản sinh viên</a></li>
                        </ul>
                    </li>

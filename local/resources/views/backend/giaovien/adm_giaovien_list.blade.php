                            ...
                            <tbody>
                                @foreach($teach as $a)
                                  <tr>
                                    ...
                                    <td><a onclick="return confirm('Bạn có chắc muốn xóa không???')" class="btn btn-danger del" data-id="{{$a->id}}" data-token="{{csrf_token()}}" value="{{$a->id}}"><i class="fa fa-trash-o"></i> Xóa</a></td>

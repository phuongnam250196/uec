                          ...
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a class="btn btn-success" href="{{url('admin/doanhnghiep/taikhoan/edit/'.$u->id)}}"><i class="fa fa-edit"></i></a></td>
                                <td><a class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" href="{{url('admin/doanhnghiep/taikhoan/delete/'.$u->id)}}"><i class="fa fa-trash-o"></i></a></td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>

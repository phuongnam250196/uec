                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="dn_user_info" value="{{$list_user->enterprise_id}}">
                                        @foreach($enter as $en)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="password" class="form-control" name="dn_user_pass" value="{{$list_user->password}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="password" class="form-control" name="dn_user_pass_2" value="{{$list_user->password}}">

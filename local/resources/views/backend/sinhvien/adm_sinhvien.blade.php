                ...
                <div class="box-body table-responsive no-padding dd">
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><span class="label label-success">{{$s->student_science}}</span></td>
                      <td>{{$s->student_class}}</td>
                      <td>{{(!empty($s->student_status)?'Tốt nghiệp': 'Chưa tốt nghiệp')}}</td>
                      <td><a href="{{asset('admin/sinhvien/thongtin/edit/'.$s->id)}}" class="btn btn-warning"><i class="fa fa-edit"></i> Sửa</a></td>
                      <td><a href="{{asset('admin/sinhvien/thongtin/delete/'.$s->id)}}" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa không?')"><i class="fa fa-trash-o"></i> Xóa</a></td>
                    </tr>
                    @endforeach
                  </table>
                </div><!-- /.box-body -->

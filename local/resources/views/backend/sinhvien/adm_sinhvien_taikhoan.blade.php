                    ...
                    <div class="box-body table-responsive no-padding dd">
                      ...
                      <table class="table table-hover" {{$dem=1}}>
                        ...
                        <tr>
                          ...
                          <td><a href="{{asset('admin/sinhvien/taikhoan/delete/'.$u->id)}}" class="btn btn-danger"><i class="fa fa-trash-o"></i> Xóa</a></td>
                        </tr>
                        @endforeach
                      </table>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="pass_2">

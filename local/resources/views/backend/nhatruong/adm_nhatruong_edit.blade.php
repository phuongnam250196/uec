                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="avatar" class="thumbnail" src="{{url('local/storage/app/school/'.$school->school_logo)}}" width="100%">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                      ...
                                      <textarea required class="form-control" rows="5" id="comment" name="nt_describe">{{$school->school_describe}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

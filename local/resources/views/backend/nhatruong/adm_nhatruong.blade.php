                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="avatar" class="thumbnail" src="{{url('public/upload/images/new_seo-10-512.png')}}" width="100%" height="170">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                      ...
                                      <textarea required class="form-control" rows="5" id="comment" name="nt_describe">{{old('nt_describe')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                          ...
                          <table class="table">
                            <tbody>
                              <tr>
                                <td>Mã trường</td>
                                <td>{{$s->school_code}}</td>
                                <td  rowspan="3" class="text-right"><img style="width:100px; height: 100px" src="{{asset('local/storage/app/school/'.$s->school_logo)}}" alt=""></td>
                              </tr>
                              <tr>
                                <td>Tên trường</td>
                                <td>{{$s->school_name}}</td>

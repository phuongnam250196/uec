                            ...
                            <tbody {{$dem=1}}>
                                @foreach($user_school as $us)
                                  <tr>
                                    ...
                                    <td>{{$us->area_id}}</td>
                                    <td><a href="{{url('admin/nhatruong/taikhoan/edit/'.$us->id)}}"><i class="fa fa-edit"></i></a></td>
                                    <td><a href="{{url('admin/nhatruong/taikhoan/delete/'.$us->id)}}"><i class="fa fa-trash-o"></i></a></td>
                                  </tr>
                                  @endforeach
                            </tbody>
                          </table>
